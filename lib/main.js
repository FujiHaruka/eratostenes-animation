...
async function main (pixiView) {
  ...
  schedule.splice(14, 0, () => boxContainer.setTextHideAnimation({frames}))
  schedule.splice(13, 1, () => boxContainer.setWaitingAnimation({frames}))
  schedule.unshift(() => boxContainer.setWaitingAnimation({frames: frames * 2}))
  schedule.push(() => boxContainer.setMarkAnimation({frames}))
  schedule.push(() => boxContainer.setMarkLeftAnimation({frames}))
  schedule.push(() => boxContainer.setWaitingAnimation({frames: frames * 2}))
